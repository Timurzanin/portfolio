...
var strokeColor = "rgba(52, 62, 186, 0.8)";
        ...
        if (this.flag == true) {
            ...
            for (var i = 0; i < this.veticies.length; i++) {
                for (var j = i; j < this.veticies.length; j++) {
                    ...
                    var distance = (this.veticies[i].affineOut.x - this.veticies[j].affineOut.x) * (this.veticies[i].affineOut.x - this.veticies[j].affineOut.x) +
